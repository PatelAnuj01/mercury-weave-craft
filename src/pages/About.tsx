...
const milestones = [
  ...
  },
  {
    ...
    description:
      "Mercury Fabrics officially incorporated with $4M initial revenue",
    icon: Calendar,
    image: img2,
  },
  {
  ...
  },
  {
    ...
    description:
      "Launched Target Zero initiative for environmental responsibility",
    icon: Target,
    image: img4,
  },
  {
...
const values = [
  {
    title: "Innovation",
    description:
      "Continuously pushing boundaries in textile technology and sustainable manufacturing processes.",
    icon: Target,
  },
  {
    title: "Quality",
    description:
      "Uncompromising commitment to premium standards in every fabric we produce.",
    icon: Award,
  },
  {
    title: "Sustainability",
    description:
      "Leading the industry towards zero waste, zero carbon, and responsible manufacturing.",
    icon: Heart,
  },
  {
    title: "Partnership",
    description:
      "Building long-term relationships based on trust, reliability, and shared success.",
    icon: Users,
  },
];
          ...
          <AnimatedSection animation="fade-in-up">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                ...
                sustainable fabric manufacturing, our journey spans over seven
                decades.
              </p>
            </div>
          </AnimatedSection>
              ...
              <AnimatedSection animation="fade-in-up">
                <div>
                  ...
                  <div className="space-y-5 text-muted-foreground leading-relaxed text-lg">
                    <p>
                      Founded in the heart of India's textile hub, Mercury
                      Fabrics has grown from humble beginnings in the 1950s to
                      become a premier manufacturer of innovative knitted
                      fabrics. Our journey is one of continuous evolution,
                      driven by a commitment to quality, sustainability, and
                      customer satisfaction.
                    </p>
                    <p>
                      Today, we operate state-of-the-art facilities that combine
                      traditional craftsmanship with cutting-edge technology.
                      Our comprehensive value chain ensures complete control
                      over quality while maintaining the flexibility to meet
                      diverse customer requirements.
                    </p>
                    <p>
                      With annual production capacity of 8,400 tonnes and
                      revenue of $40M, we serve over 50 global clients including
                      industry leaders like H&M, Puma, and Uniqlo. Our success
                      is built on trust, innovation, and an unwavering
                  ...
                  <Card className="p-10 rounded-2xl shadow-2xl border border-red-300/40 bg-white/90 backdrop-blur-lg relative overflow-hidden">
                    ...
                    <CardContent className="relative z-10 p-0">
                      <div className="grid grid-cols-2 gap-8">
                        <div className="text-center">
                          <div className="text-4xl font-extrabold text-[#f24545] mb-2">
                        ...
                        <div className="text-center">
                          <div className="text-4xl font-extrabold text-[#f24545] mb-2">
                            <CountUp start={0} end={8400} duration={4} separator="," />
                          </div>
                          <div className="text-base text-gray-700 font-medium">Tonnes/Year</div>
                        </div>
                        <div className="text-center">
                          <div className="text-4xl font-extrabold text-[#f24545] mb-2">
                            $<CountUp start={0} end={40} duration={6} />M
                          </div>
          ...
          <AnimatedSection animation="fade-in-up">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Key milestones that shaped Mercury Fabrics into the industry
                leader we are today
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection animation="fade-in-up">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Partner with Mercury Fabrics and become part of our continuing
              journey of innovation, quality, and sustainable growth.
            </p>
          </AnimatedSection>
        </div>
      </section>
